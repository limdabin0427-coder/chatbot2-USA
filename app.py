...
def question_retry_response(stage, original, ambiguity_options=None):
    ...
    default_examples = {
        Stage.STUDENT_QUESTION_1.value: "Do you like burgers?",
        Stage.STUDENT_QUESTION_2.value: "Do you like hot dogs?",
        Stage.STUDENT_QUESTION_3.value: "Do you like donuts?",
    }
    ...
    if attempt >= QUESTION_CONFIRMATION_ATTEMPT:
        ...
        candidate_questions.append(default_examples.get(stage, "Do you like donuts?"))

        fallback_foods = {
            Stage.STUDENT_QUESTION_1.value: ["burgers", "hot dogs", "donuts"],
            Stage.STUDENT_QUESTION_2.value: ["hot dogs", "burgers", "donuts"],
            Stage.STUDENT_QUESTION_3.value: ["donuts", "burgers", "hot dogs"],
        }
        candidate_questions.extend(
            f"Do you like {food_name}?"
            for food_name in fallback_foods.get(stage, ["donuts"])
        )

        asked_foods = set(session.get("asked_foods", []))
        suggested_question = "Do you like donuts?"
